 ...
 */
class train extends \OCP\AppliBundle\Entity\train implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'OCP\\AppliBundle\\Entity\\train' . "\0" . 'id', '' . "\0" . 'OCP\\AppliBundle\\Entity\\train' . "\0" . 'numero');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (train $proxy) {
